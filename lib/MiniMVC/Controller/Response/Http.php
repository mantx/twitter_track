<?php
/**
 * MiniMVC_Controller_Response_Http
 */
class MiniMVC_Controller_Response_Http
{
    /**
     * Body content
     * @var array
     ...
     * @return MiniMVC_Controller_Response_Http
     */
    ...
    public function setHttpResponseCode($code)
    {
        if (!is_int($code) || (100 > $code) || (599 < $code)) {
            #require_once 'MiniMVC/Controller/Response/Exception.php';
